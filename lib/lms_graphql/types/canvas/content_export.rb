  ...
  module Types
    module Canvas
      ...
      class ContentExport < BaseType
        ...
        field :attachment, LMSGraphQL::Types::Canvas::File, "attachment api object for the export package (not present before the export completes or after it becomes unavailable for download.).Example: https://example.com/api/v1/attachments/789?download_frd=1&verifier=bG9sY2F0cyEh", null: true
