...
module LMSGraphQL
 ...
 - 'failed': The outcome import failed..Example: imported", null: true
        field :data, LMSGraphQL::Types::Canvas::OutcomeImportDatum, "See the OutcomeImportData specification above..", null: true
        field :progress, String, "The progress of the outcome import..Example: 100", null: true
        field :user, LMSGraphQL::Types::Canvas::User, "The user that initiated the outcome_import. See the Users API for details..", null: true
