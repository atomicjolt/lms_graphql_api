  ...
  module Types
    module Canvas
      class CanvasBlueprintMigrationInput < BaseInputObject
        ...
        argument :created_at, GraphQL::Types::ISO8601DateTime, "Time when the migration was queued.Example: 2013-08-28T23:59:00-06:00", required: false
        argument :exports_started_at, GraphQL::Types::ISO8601DateTime, "Time when the exports begun.Example: 2013-08-28T23:59:00-06:00", required: false
        argument :imports_queued_at, GraphQL::Types::ISO8601DateTime, "Time when the exports were completed and imports were queued.Example: 2013-08-28T23:59:00-06:00", required: false
        argument :imports_completed_at, GraphQL::Types::ISO8601DateTime, "Time when the imports were completed.Example: 2013-08-28T23:59:00-06:00", required: false
