  ...
  module Types
    module Canvas
      class CanvasModuleInput < BaseInputObject
        ...
        argument :unlock_at, GraphQL::Types::ISO8601DateTime, "(Optional) the date this module will unlock.Example: 2012-12-31T06:00:00-06:00", required: false
        ...
        argument :completed_at, GraphQL::Types::ISO8601DateTime, "the date the calling user completed the module (Optional; present only if the caller is a student or if the optional parameter 'student_id' is included).", required: false
