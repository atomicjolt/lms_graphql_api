  ...
  module Types
    module Canvas
      class CanvasBlackoutDate < BaseType
        ...
        field :start_date, LMSGraphQL::Types::DateTimeType, "the start date of the blackout date.Example: 2022-01-01", null: true
        field :end_date, LMSGraphQL::Types::DateTimeType, "the end date of the blackout date.Example: 2022-01-02", null: true
