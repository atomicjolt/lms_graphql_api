  ...
  module Types
    module Canvas
      class CanvasSubmission < BaseType
        ...
        field :submitted_at, GraphQL::Types::ISO8601DateTime, "The timestamp when the assignment was submitted.Example: 2012-01-01T01:00:00Z", null: true
        ...
        field :graded_at, GraphQL::Types::ISO8601DateTime, "Example: 2012-01-02T03:05:34Z", null: true
        ...
        field :posted_at, GraphQL::Types::ISO8601DateTime, "The date this submission was posted to the student, or nil if it has not been posted..Example: 2020-01-02T11:10:30Z", null: true
