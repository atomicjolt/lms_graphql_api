  ...
  module Types
    module Canvas
      class CanvasSubmissionComment < BaseType
        ...
        field :created_at, GraphQL::Types::ISO8601DateTime, "Example: 2012-01-01T01:00:00Z", null: true
        field :edited_at, GraphQL::Types::ISO8601DateTime, "Example: 2012-01-02T01:00:00Z", null: true
