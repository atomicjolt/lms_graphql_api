  ...
  module Types
    module Canvas
      class PageRevision < BaseType
        ...
        field :updated_at, LMSGraphQL::Types::DateTimeType, "the time when this revision was saved.Example: 2012-08-07T11:23:58-06:00", null: true
        field :latest, Boolean, "whether this is the latest revision or not.Example: true", null: true
        field :edited_by, LMSGraphQL::Types::Canvas::User, "the User who saved this revision, if applicable (this may not be present if the page was imported from another system).", null: true
