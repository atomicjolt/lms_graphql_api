...
module LMSGraphQL
  module Types
    module Canvas
      class CanvasSisImportInput < BaseInputObject
        ...
        argument :created_at, GraphQL::Types::ISO8601DateTime, "The date the SIS import was created..Example: 2013-12-01T23:59:00-06:00", required: false
        argument :ended_at, GraphQL::Types::ISO8601DateTime, "The date the SIS import finished. Returns null if not finished..Example: 2013-12-02T00:03:21-06:00", required: false
        argument :updated_at, GraphQL::Types::ISO8601DateTime, "The date the SIS import was last updated..Example: 2013-12-02T00:03:21-06:00", required: false
 ...
 - 'restored': The SIS import is restored all of the states of imported items..Example: imported", required: false
        ...
        argument :diffing_threshold_exceeded, Boolean, "Whether a diffing job failed because the threshold limit got exceeded..Example: true", required: false
        ...
        argument :diffing_remaster, Boolean, "Whether diffing remaster data was enabled..Example: false", required: false
