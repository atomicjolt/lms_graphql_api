  ...
  module Types
    module Canvas
      ...
      class Assignment < BaseType
        ...
        field :all_dates, [LMSGraphQL::Types::Canvas::AssignmentDate], "(Optional) all dates associated with the assignment, if applicable.", null: true
        ...
        field :discussion_topic, LMSGraphQL::Types::Canvas::DiscussionTopic, "(Optional) the DiscussionTopic associated with the assignment, if applicable.", null: true
        ...
        field :rubric, [LMSGraphQL::Types::Canvas::RubricCriterium], "(Optional) A list of scoring criteria and ratings for each rubric criterion. Included if there is an associated rubric..", null: true
        ...
        field :overrides, [LMSGraphQL::Types::Canvas::AssignmentOverride], "(Optional) If 'overrides' is included in the 'include' parameter, includes an array of assignment override objects..", null: true
