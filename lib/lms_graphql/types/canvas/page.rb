  ...
  module Types
    module Canvas
      class Page < BaseType
        ...
        field :last_edited_by, LMSGraphQL::Types::Canvas::User, "the User who last edited the page (this may not be present if the page was imported from another system).", null: true
