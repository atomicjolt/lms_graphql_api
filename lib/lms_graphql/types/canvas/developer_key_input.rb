  ...
  module Types
    module Canvas
      class CanvasDeveloperKeyInput < BaseInputObject
        ...
        argument :last_used_at, GraphQL::Types::ISO8601DateTime, "The date and time the tool was last used.Example: 2019-06-07T20:34:33Z", required: false
        ...
        argument :created_at, GraphQL::Types::ISO8601DateTime, "The time the jwk was created.Example: 2019-06-07T20:34:33Z", required: false
