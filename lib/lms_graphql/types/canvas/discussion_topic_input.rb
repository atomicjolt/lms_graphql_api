  ...
  module Types
    module Canvas
      class CanvasDiscussionTopicInput < BaseInputObject
        ...
        argument :posted_at, GraphQL::Types::ISO8601DateTime, "The datetime the topic was posted. If it is null it hasn't been posted yet. (see delayed_post_at).Example: 2037-07-21T13:29:31Z", required: false
        argument :last_reply_at, GraphQL::Types::ISO8601DateTime, "The datetime for when the last reply was in the topic..Example: 2037-07-28T19:38:31Z", required: false
        ...
        argument :delayed_post_at, GraphQL::Types::ISO8601DateTime, "The datetime to publish the topic (if not right away)..", required: false
        ...
        argument :lock_at, GraphQL::Types::ISO8601DateTime, "The datetime to lock the topic (if ever)..", required: false
