...
module LMSGraphQL
  module Types
    module Canvas
      class CanvasModuleItemSequence < BaseType
        ...
        field :modules, [LMSGraphQL::Types::Canvas::CanvasModule], "an array containing each Module referenced above.Example: {'id'=>123, 'name'=>'Overview'}, {'id'=>127, 'name'=>'Imaginary Numbers'}", null: true
