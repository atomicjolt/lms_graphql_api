  ...
  module Types
    module Canvas
      class CanvasePortfolioInput < BaseInputObject
        ...
        argument :deleted_at, GraphQL::Types::ISO8601DateTime, "The timestamp when the ePortfolio was deleted, or else null.Example: 2021-09-20T18:59:37Z", required: false
