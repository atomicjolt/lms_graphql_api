  ...
  module Types
    module Canvas
      class CanvasAssignmentOverrideInput < BaseInputObject
        ...
        argument :due_at, GraphQL::Types::ISO8601DateTime, "the overridden due at (present if due_at is overridden).Example: 2012-07-01T23:59:00-06:00", required: false
        argument :all_day, Boolean, "the overridden all day flag (present if due_at is overridden).Example: true", required: false
        argument :all_day_date, GraphQL::Types::ISO8601DateTime, "the overridden all day date (present if due_at is overridden).Example: 2012-07-01", required: false
        argument :unlock_at, GraphQL::Types::ISO8601DateTime, "the overridden unlock at (present if unlock_at is overridden).Example: 2012-07-01T23:59:00-06:00", required: false
        argument :lock_at, GraphQL::Types::ISO8601DateTime, "the overridden lock at, if any (present if lock_at is overridden).Example: 2012-07-01T23:59:00-06:00", required: false
