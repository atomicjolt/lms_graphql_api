...
NOTE: AVAILABLE ONLY IN NON-JSON-API REQUESTS..Example: 2", null: true
      	...
      	field :submission_statistics, LMSGraphQL::Types::Canvas::CanvasQuizStatisticsSubmissionStatistic, "Question-specific statistics for each question and its answers..", null: true
      	field :links, LMSGraphQL::Types::Canvas::CanvasQuizStatisticsLink, "JSON-API construct that contains links to media related to this quiz statistics object. 
