...
NOTE: AVAILABLE ONLY IN NON-JSON-API REQUESTS..Example: 2", null: true
        ...
        field :question_statistics, LMSGraphQL::Types::Canvas::QuizStatisticsQuestionStatistic, "Question-specific statistics for each question and its answers..", null: true
        field :submission_statistics, LMSGraphQL::Types::Canvas::QuizStatisticsSubmissionStatistic, "Question-specific statistics for each question and its answers..", null: true
        field :links, LMSGraphQL::Types::Canvas::QuizStatisticsLink, "JSON-API construct that contains links to media related to this quiz statistics object. 
