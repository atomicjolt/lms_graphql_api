  ...
  module Types
    module Canvas
      class CanvasChangeRecordInput < BaseInputObject
        ...
        argument :asset_type, String, "The type of the learning object that was changed in the blueprint course.  One of 'assignment', 'attachment', 'discussion_topic', 'external_tool', 'quiz', or 'wiki_page'..Example: assignment", required: false
