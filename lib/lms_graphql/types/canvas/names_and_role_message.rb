  ...
  module Types
    module Canvas
      class CanvasNamesAndRoleMessage < BaseType
        ...
        field :lti_claim_message_type, String, "The type of LTI message being described. Always set to 'LtiResourceLinkRequest'.Example: LtiResourceLinkRequest", null: true
        ...
        field :lti_claim_custom, String, "Expanded LTI custom parameters that pertain to the member (as opposed to the Context).Example: en, America/Denver", null: true
