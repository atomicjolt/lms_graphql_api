  ...
  module Types
    module Canvas
      class CanvasMigrationIssueInput < BaseInputObject
        ...
        argument :created_at, GraphQL::Types::ISO8601DateTime, "timestamp.Example: 2012-06-01T00:00:00-06:00", required: false
        argument :updated_at, GraphQL::Types::ISO8601DateTime, "timestamp.Example: 2012-06-01T00:00:00-06:00", required: false
