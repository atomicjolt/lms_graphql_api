  ...
  module Types
    module Canvas
      class CanvasOutcomeLink < BaseType
        ...
        field :outcome_group, LMSGraphQL::Types::Canvas::CanvasOutcomeGroup, "an abbreviated OutcomeGroup object representing the group containing the outcome link..", null: true
        field :outcome, LMSGraphQL::Types::Canvas::CanvasOutcome, "an abbreviated Outcome object representing the outcome linked into the containing outcome group..", null: true
