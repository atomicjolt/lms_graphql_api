  ...
  module Types
    module Canvas
      class OutcomeLink < BaseType
        ...
        field :outcome_group, LMSGraphQL::Types::Canvas::OutcomeGroup, "an abbreviated OutcomeGroup object representing the group containing the outcome link..", null: true
        field :outcome, LMSGraphQL::Types::Canvas::Outcome, "an abbreviated Outcome object representing the outcome linked into the containing outcome group..", null: true
