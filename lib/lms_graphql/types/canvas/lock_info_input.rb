  ...
  module Types
    module Canvas
      class CanvasLockInfoInput < BaseInputObject
        ...
        argument :unlock_at, GraphQL::Types::ISO8601DateTime, "(Optional) Time at which this was/will be unlocked. Must be before the due date..Example: 2013-01-01T00:00:00-06:00", required: false
        argument :lock_at, GraphQL::Types::ISO8601DateTime, "(Optional) Time at which this was/will be locked. Must be after the due date..Example: 2013-02-01T00:00:00-06:00", required: false
