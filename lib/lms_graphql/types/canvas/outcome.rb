  ...
  module Types
    module Canvas
      ...
      class Outcome < BaseType
        ...
        field :ratings, [LMSGraphQL::Types::Canvas::RubricRating], "possible ratings for this outcome. included only if the outcome embeds a rubric criterion. omitted in the abbreviated form..", null: true
