  ...
  module Types
    module Canvas
      class CanvasLtiAssignmentInput < BaseInputObject
        ...
        argument :due_at, GraphQL::Types::ISO8601DateTime, "The due date for the assignment. If a user id is supplied and an assignment override is in place this field will reflect the due date as it applies to the user..Example: 2012-07-01T23:59:00-06:00", required: false
