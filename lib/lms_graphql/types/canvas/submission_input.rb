  ...
  module Types
    module Canvas
      class CanvasSubmissionInput < BaseInputObject
        ...
        argument :submitted_at, GraphQL::Types::ISO8601DateTime, "The timestamp when the assignment was submitted.Example: 2012-01-01T01:00:00Z", required: false
        ...
        argument :graded_at, GraphQL::Types::ISO8601DateTime, "Example: 2012-01-02T03:05:34Z", required: false
        ...
        argument :late_policy_status, String, "The status of the submission in relation to the late policy. Can be late, missing, extended, none, or null..Example: missing", required: false
        ...
        argument :posted_at, GraphQL::Types::ISO8601DateTime, "The date this submission was posted to the student, or nil if it has not been posted..Example: 2020-01-02T11:10:30Z", required: false
        ...
        argument :redo_request, Boolean, "This indicates whether the submission has been reassigned by the instructor..Example: true", required: false
