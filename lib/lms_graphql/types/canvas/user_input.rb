  ...
  module Types
    module Canvas
      class CanvasUserInput < BaseInputObject
        ...
        argument :avatar_state, String, "Optional: If avatars are enabled and caller is admin, this field can be requested and will contain the current state of the user's avatar..Example: approved", required: false
