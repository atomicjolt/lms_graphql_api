...
module LMSGraphQL
  module Types
    module Canvas
      ...
      argument :created_at, LMSGraphQL::Types::DateTimeType, "the time at which this late policy was originally created.Example: 2012-07-01T23:59:00-06:00", required: false
      argument :updated_at, LMSGraphQL::Types::DateTimeType, "the time at which this late policy was last modified in any way.Example: 2012-07-01T23:59:00-06:00", required: false
