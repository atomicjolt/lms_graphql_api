  ...
  module Types
    module Canvas
      class CanvasAssignmentInput < BaseInputObject
        ...
        argument :updated_at, GraphQL::Types::ISO8601DateTime, "The time at which this assignment was last modified in any way.Example: 2012-07-01T23:59:00-06:00", required: false
        ...
        argument :lock_at, GraphQL::Types::ISO8601DateTime, "the lock date (assignment is locked after this date). returns null if not present. NOTE: If this assignment has assignment overrides, this field will be the lock date as it applies to the user requesting information from the API..Example: 2012-07-01T23:59:00-06:00", required: false
