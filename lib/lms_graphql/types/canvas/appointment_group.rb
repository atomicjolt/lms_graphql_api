  ...
  module Types
    module Canvas
      ...
      class AppointmentGroup < BaseType
        ...
        field :reserved_times, [LMSGraphQL::Types::Canvas::Appointment], "The start and end times of slots reserved by the current user as well as the id of the calendar event for the reservation (see include[] argument).Example: {'id'=>987, 'start_at'=>'2012-07-20T15:00:00-06:00', 'end_at'=>'2012-07-20T15:00:00-06:00'}", null: true
        ...
        field :appointments, [LMSGraphQL::Types::Canvas::CalendarEvent], "Calendar Events representing the time slots (see include[] argument) Refer to the Calendar Events API for more information.", null: true
        field :new_appointments, [LMSGraphQL::Types::Canvas::CalendarEvent], "Newly created time slots (same format as appointments above). Only returned in Create/Update responses where new time slots have been added.", null: true
