  ...
  module Mutations
    module Canvas
      class UpdateSingleGradingPeriod < BaseMutation
        ...
        argument :grading_periods_start_date, [GraphQL::Types::ISO8601DateTime], required: true
        argument :grading_periods_end_date, [GraphQL::Types::ISO8601DateTime], required: true
