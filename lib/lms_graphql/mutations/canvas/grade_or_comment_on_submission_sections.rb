...
module LMSGraphQL
  module Mutations
    module Canvas
      class GradeOrCommentOnSubmissionSection < BaseMutation
        ...
        def resolve(section_id:, assignment_id:, user_id:, comment_text_comment: nil, comment_attempt: nil, comment_group_comment: nil, comment_media_comment_id: nil, comment_media_comment_type: nil, comment_file_ids: nil, include_visibility: nil, prefer_points_over_scheme: nil, submission_posted_grade: nil, submission_excuse: nil, submission_late_policy_status: nil, submission_seconds_late_override: nil, rubric_assessment: nil)
