  ...
  module Mutations
    module Canvas
      class UpdateCreatePageGroup < BaseMutation
        ...
        def resolve(group_id:, url_or_id:, wiki_page_title: nil, wiki_page_body: nil, wiki_page_editing_roles: nil, wiki_page_notify_of_update: nil, wiki_page_published: nil, wiki_page_front_page: nil)
          context[:canvas_api].call("UPDATE_CREATE_PAGE_GROUPS").proxy(
