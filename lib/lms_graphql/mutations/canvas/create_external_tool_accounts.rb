  ...
  module Mutations
    module Canvas
      class CreateExternalToolAccount < BaseMutation
        ...
        argument :is_rce_favorite, Boolean, required: false
        ...
        argument :course_navigation_default, String, required: false
