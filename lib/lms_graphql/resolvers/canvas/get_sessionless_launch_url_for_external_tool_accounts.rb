  ...
  module Resolvers
    module Canvas
      class GetSessionlessLaunchUrlForExternalToolAccount < CanvasBaseResolver
        ...
        def resolve(account_id:, id: nil, url: nil, assignment_id: nil, module_item_id: nil, launch_type: nil, get_all: false)
          result = context[:canvas_api].call("GET_SESSIONLESS_LAUNCH_URL_FOR_EXTERNAL_TOOL_ACCOUNTS").proxy(
