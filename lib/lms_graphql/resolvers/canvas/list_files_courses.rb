  ...
  module Resolvers
    module Canvas
      class ListFilesCourse < CanvasBaseResolver
        ...
        def resolve(course_id:, content_types: nil, exclude_content_types: nil, search_term: nil, include: nil, only: nil, sort: nil, order: nil, get_all: false)
          result = context[:canvas_api].call("LIST_FILES_COURSES").proxy(
            "LIST_FILES_COURSES",
            {
              "course_id": course_id,
